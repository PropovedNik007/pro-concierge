<script lang="ts">
	...
	// 				const wakeUpTime = new Date(event.startDate!);
	...
	// 			const lunchTime = new Date(event.startDate!);
	// 			lunchTime.setHours(12, 0, 0, 0);
	// 			if (!day.events.some((e) => e.startDate?.getHours() === 12)) {
	// 				day.events.push({
	// 					id: `lunch-${event.id}`,
	// 					summary: 'Lunch',
	// 					startDate: lunchTime,
	// 					endDate: new Date(lunchTime.getTime() + 60 * 60000),
	// 					isSuggested: true
	// 				});
	// 			}
	...
	// 		// Sort events by start time to find the first and last task of the day
	...
	// 		// Suggest Wake-Up an hour before the first task of the day
	...
	// 		// Suggest Lunch at noon or before the first task after noon
	// 		const lunchTime = new Date(firstTask.startDate);
	// 		lunchTime.setHours(12, 0, 0, 0);
	// 		const hasLunch = day.events.some((e) => e.startDate?.getHours() === 12);
	// 		if (!hasLunch) {
	// 			const afternoonTask = day.events.find((e) => (e.startDate?.getHours() || 0) >= 12);
	// 			const lunchEndTime = new Date(afternoonTask?.startDate || lunchTime);
	// 			lunchEndTime.setMinutes(lunchEndTime.getMinutes() - 60); // Ensure lunch ends by the afternoon task
	...
	// 		// Suggest Transfer if there are meetings or conferences with location details
	// 		day.events.forEach((event) => {
	// 			if (
	// 				event.summary?.toLowerCase().includes('meeting') ||
	...
	// 		// Suggest cross-sell items after the day's tasks are completed
	// 		const crossSellStart = new Date(lastTask.endDate || lastTask.startDate!);
	// 		crossSellStart.setMinutes(crossSellStart.getMinutes() + 30); // 30 minutes after the last task
	...
	// 				endDate: new Date(crossSellStart.getTime() + 60 * 60000), // 1 hour spa
	// 				isSuggested: true
	// 			},
	// 			{
	// 				id: `dinner-${lastTask.id}`,
	// 				summary: 'Dinner Reservation',
	// 				startDate: new Date(crossSellStart.getTime() + 90 * 60000), // 1.5 hours after spa start
	// 				endDate: new Date(crossSellStart.getTime() + 120 * 60000), // 2 hours for dinner
	// 				isSuggested: true
	// 			}
	// 		);
	// 	});
	...
	// 		// Suggest Lunch at 12 PM or right before the first afternoon task (if scheduled after noon)
	// 		const lunchTime = new Date(firstTask.startDate);
	// 		lunchTime.setHours(12, 0, 0, 0);
	// 		const afternoonTask = day.events.find((e) => e.startDate && e.startDate.getHours() >= 13);
	// 		const lunchEndTime = afternoonTask
	// 			? new Date(afternoonTask.startDate.getTime() - 60 * 60000)
	// 			: new Date(lunchTime.getTime() + 60 * 60000);

	// 		if (!day.events.some((e) => e.startDate && e.startDate.getHours() === 12)) {
	// 			day.events.push({
	// 				id: `lunch-${firstTask.id}`,
	// 				summary: 'Lunch',
	// 				startDate: lunchTime,
	...
	// 		// Suggest Transfer for events with "meeting" or "conference" in the summary, 30 minutes before start
	// 		day.events.forEach((event) => {
	// 			if (
	// 				(event.summary?.toLowerCase().includes('meeting') ||
	// 					event.summary?.toLowerCase().includes('conference')) &&
	...
	// 		// Suggest cross-sell items after the last task of the day
	...
	// 					summary: 'Dinner Reservation',
	// 					startDate: new Date(crossSellStart.getTime() + 90 * 60000), // 1.5 hours after spa start
	// 					endDate: new Date(crossSellStart.getTime() + 120 * 60000), // 2-hour dinner
	// 					isSuggested: true
	// 				}
	// 			);
	// 		}
	...
	// 		if (
	// 			!day.events.some((e) => e.startDate && e.startDate.getHours() === lunchStart.getHours())
	// 		) {
	// 			day.events.push({
	// 				id: `lunch-${firstTask.id}`,
	// 				summary: 'Lunch',
